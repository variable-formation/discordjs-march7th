...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('fx') // Set the command name to 'ping'.
        .setDescription('Replaces a Twitter, X, or Nitter URL with fxtwitter.') // Set the command description.
    ...
    async execute(interaction) {
        ...
        if (link.startsWith("https://twitter.com")) {
            link = link.replace("https://twitter.com", "https://fxtwitter.com");
            interaction.editReply({ content: link, components: [row], ephemeral: false });
        } else if (link.startsWith("https://x.com")) {
            link = link.replace("https://x.com", "https://fxtwitter.com");
            interaction.editReply({ content: link, components: [row], ephemeral: false });
        } else if (link.startsWith("https://nitter.net")) {
            link = link.replace("https://nitter.net", "https://fxtwitter.com");
            interaction.editReply({ content: link, components: [row], ephemeral: false });
        } else if (link.startsWith("https://fxtwitter.com")) {
            interaction.editReply({ content: "That's already an fxtwitter link!", ephemeral: false });
        } else {

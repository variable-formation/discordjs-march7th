...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('phixiv') // Set the command name to 'ping'.
        .setDescription('Replaces a Pixiv URL with a Phixiv URL.') // Set the command description.
    ...
    async execute(interaction) {
        ...
        if (link.startsWith("https://www.pixiv.net")) {
            link = link.replace("https://www.pixiv.net", "https://www.phixiv.net");
